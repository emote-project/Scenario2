...
namespace System.Windows.Forms
{
     ...
     * 
     * 
     * Corrected some outdated namespaces.
     * Tiago Ribeiro
     * */
    public class RadioListBox : ListBox
    {
        ...
        public override Color BackColor
        {
            ...
            set
            {
                ...
                {
                    IsTransparent = true;
                    base.BackColor = (this.Parent == null) ? System.Drawing.SystemColors.Window : this.Parent.BackColor;
                }
                else
                {
                    IsTransparent = false;
        ...
        protected override void OnDrawItem(DrawItemEventArgs e)
        {
            ...
            Drawing.Size glyphSize = RadioButtonRenderer.GetGlyphSize(e.Graphics, state);
            Drawing.Point glyphLocation = e.Bounds.Location;
