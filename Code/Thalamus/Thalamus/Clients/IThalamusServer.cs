...
namespace Thalamus
{
    ...
    {
        [XmlRpcMethod()]
        string Connect(string name, string clientId, int port, int numSubscribedEvents);
        ...
        [XmlRpcMethod()]
        void Pong(string clientId);

        [XmlRpcMethod()]
        void AnnounceEventInformation(string clientId, string[] perceptionName, string[][] parameters, string[][] types, string[] enumNames, string[][] enums);
