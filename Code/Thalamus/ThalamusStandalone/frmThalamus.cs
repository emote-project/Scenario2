    ...
    public partial class frmThalamus : Form
    {
        ...
        private void RefreshTabEvents()
        {
            ...
            try {
                ...
                else
                {
                    ...
                    {
                        if (ev.Name.ToLower().Contains("action"))
                        {
        ...
        private void RefreshTabCreate()
        {
            ...
            else
            {
                ...
                lblCharacterPort.Text = selectedCharacter.Clients.LocalPort.ToString();
                ...
                for (int i = 0; i < lstBodyServer.Items.Count; i++)
                {
