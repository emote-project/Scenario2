...
namespace Thalamus.BML
{
    ...
    public interface IBMLActions : ISpeakActions, IGazeActions, ILocomotionActions, IAnimationActions, IPostureActions, ISoundActions, IFaceActions, IPointingActions, IHeadActions
    {}

    public interface IBMLEvents : ISpeakEvents, IGazeEvents, ILocomotionEvents, IAnimationEvents, IPostureEvents, ISoundEvents, IFaceEvents, IPointingEvents, IHeadEvents { }
