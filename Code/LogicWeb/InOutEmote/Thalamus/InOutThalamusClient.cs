...
{
    public partial class InOutThalamusClient : ThalamusClient, IAllPerceptionClient
    {
        ...
        public IAllActionPublisher IOPublisher { get; private set; }

        private InOutThalamusClient() : base("InOutLibEmote", "")
        {
            SetPublisher<IAllActionPublisher>();
            IOPublisher = new InOutThalamusPublisher(Publisher);
        }



        #region Thalamus events handling
        ...
        void IEnercitiesClassificationEvent.ClassifierResult(string label)
        {
            if (ClassifierResultEvent != null) ClassifierResultEvent(this, new ClassificationEventArgs() { Label = label} );
        }

        public void EmotionalClimateLevel(EmotionalClimateLevel level)
        {
            if (EmotionalClimateChangedEvent!=null) EmotionalClimateChangedEvent(this, new EmotionalClimateChangedEventArgs(){ ECLevel = level});
        }

        # endregion


        #region Not handled thalamus events
        ...
        public event EventHandler<ClassificationEventArgs> ClassifierResultEvent;
        public event EventHandler<EmotionalClimateChangedEventArgs> EmotionalClimateChangedEvent;
